  ...
  internal static class MarshalUtils
  {
    ...
    public static VariantType? ConvertMarshalTypeToVariantType(MarshalType marshalType)
        => marshalType switch
        {
          ...
          MarshalType.GodotStructAsDictionary => VariantType.Dictionary,
        ...
        string inputExpr, ITypeSymbol typeSymbol, MarshalType marshalType)
    {
      return marshalType switch
      {
        ...
        MarshalType.GodotStructAsDictionary =>
            source.Append(typeSymbol.FullQualifiedNameIncludeGlobal(),
                ".FromGodotDictionary(", VariantUtils, ".ConvertToDictionary(", inputExpr, "))"),
        ...
        string inputExpr, ITypeSymbol typeSymbol, MarshalType marshalType)
    {
      return marshalType switch
      {
        ...
        MarshalType.GodotStructAsDictionary =>
            source.Append(VariantUtils, ".CreateFromDictionary(", inputExpr, ".ToGodotDictionary())"),
        MarshalType.GodotGenericArray =>
        ...
        string inputExpr, ITypeSymbol typeSymbol, MarshalType marshalType)
    {
      return marshalType switch
      {
        ...
        MarshalType.GodotStructAsDictionary =>
            source.Append("global::Godot.Variant.CreateFrom(", inputExpr, ".ToGodotDictionary())"),
